...
public class ZombieAI_Tank : MonoBehaviour
{
    ...
    [Header("Tank Stats")]
    [SerializeField] private int damage = 20;                 // Higher damage for tank
    [SerializeField] private float attackRange = 2f;          // Distance within which zombie can attack
    [SerializeField] private float chaseStoppingDistance = 1.5f; // Stopping distance during chase
    [SerializeField] private float patrolStoppingDistance = 0.1f; // Stopping distance during patrol

    [Header("Vision Settings")]
    [SerializeField] private float visionAngle = 110f;        // Vision cone angle
    [SerializeField] private float lostPlayerMemoryTime = 8f; // Time to remember player's last position
    [SerializeField] private LayerMask visionObstacleMask;    // Obstacles blocking vision

    [Header("Patrol Settings")]
    [SerializeField] private float idleTime = 2f;             // Time spent idling
    [SerializeField] private float patrolRadius = 8f;         // Patrol radius around start position
